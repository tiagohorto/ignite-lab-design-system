  ...
  return (
    <div className='w-screen h-screen bg-gray-900 flex items-center justify-center text-gray-100 flex-col'>
      ...
      <header className='flex flex-col items-center'>
        ...
        <Text size='lg' className='text-gray-400 mt-1'>Faz login e começa a usar!</Text>
      </header>
      ...
      <form className='flex flex-col items-stretch w-full max-w-sm mt-10 gap-4'>
        <label htmlFor='email' className='flex flex-col gap-3'>
          ...
          <TextInput.Root>
            ...
            <TextInput.Input id='email' placeholder='Digita o e-mail'/>
          </TextInput.Root>
        </label>
      ...
      <footer className='flex flex-col items-center gap-4 mt-8'>
        <Text asChild size='sm'>
          <a href='' className='text-gray-400 underline hover:text-gray-200'>Esqueceu-se da password?</a>
        </Text>
        <Text asChild size='sm'>
